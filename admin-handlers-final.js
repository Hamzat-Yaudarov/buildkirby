...
⏱️ Среднее время ответа: ${Math.round(stats?.avg_response_time/1000) || 0}с
...
🎯 **Уровни сложности (упрощено до 2):**
• Легкий: простые задачи для новых пользователей (по умолчанию)
• Сложный: комбинированные задачи для подозрительных пользователей
